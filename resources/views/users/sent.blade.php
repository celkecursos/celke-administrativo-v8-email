    ...
    <div class="content-box">
        ...
        <div class="form-group-grid-container">
            ...
            <div class="profile-content-container">
                ...
                <!-- Seção: E-mails Enviados (única visível nesta página) -->
                <div id="sent" class="profile-section">
                                ...
                                <table class="table">
                                    <thead>
                                        <tr class="table-row-header">
                                            ...
                                            <th class="table-header">Enviado em</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                            ...
                                            <tr>
                                                <td colspan="3" class="table-body text-center">
                                                    <div class="alert-warning">
                                                        Nenhum e-mail enviado encontrado para este usuário.
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforelse
