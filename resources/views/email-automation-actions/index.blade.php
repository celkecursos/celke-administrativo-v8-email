...
@section('content')
    ...
    <x-breadcrumb title="Ações Automatizadas" :items="[['label' => 'Dashboard', 'url' => route('dashboard.index')], ['label' => 'Ações Automatizadas']]" />

    <div class="content-box">

        <x-content-box-header title="Ações Automatizadas" :buttons="[
            [
                'label' => 'Cadastrar',
                'url' => route('email-automation-actions.create'),
                'permission' => 'create-email-automation-action',
        ...
        <form class="form-search">
            ...
            <input type="text" name="name" class="form-input" placeholder="Digite o nome da ação"
                value="{{ $name }}">
            ...
            <div class="flex gap-1">
                ...
                <a href="{{ route('email-automation-actions.index') }}" type="submit"
            ...
            <table class="table">
                <thead>
                    <tr class="table-row-header">
                        ...
                        <th class="table-header">Recursivo</th>
                ...
                <tbody>
                    ...
                    @forelse ($emailAutomationActions as $emailAutomationAction)
                        <tr class="table-row-body">
                            <td class="table-body">{{ $emailAutomationAction->id }}</td>
                            <td class="table-body">{{ $emailAutomationAction->name }}</td>
                            <td class="table-body">
                            ...
                            <td class="table-actions">
                                <x-table-actions :actions="[
                                    [
                                        'can' => 'show-email-automation-action',
                                        'type' => 'link',
                                    ...
                                    [
                                        'can' => 'edit-email-automation-action',
                                        'type' => 'link',
                                    ...
                                    [
                                        'can' => 'destroy-email-automation-action',
                                        'type' => 'delete',
                                        'id' => $emailAutomationAction->id,
                                        'url' => route('email-automation-actions.destroy', $emailAutomationAction->id),
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="table-body">Nenhuma ação automatizada encontrada!</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        {{ $emailAutomationActions->appends(['name' => $name])->links() }}
    </div>
@endsection
