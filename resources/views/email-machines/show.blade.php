        ...
        {{-- <div class="content-box-header">
            ...
            <div class="content-box-btn">
                @can('index-email-machine')
                    <a href="{{ route('email-machines.index') }}" class="btn-info align-icon-btn">
                ...
                @can('edit-email-machine')
                    <a href="{{ route('email-machines.edit', ['emailMachine' => $emailMachine->id]) }}"
                ...
                @can('destroy-email-machine')
                    <form id="delete-form-{{ $emailMachine->id }}"
                        action="{{ route('email-machines.destroy', ['emailMachine' => $emailMachine->id]) }}" method="POST">
                        @csrf
                        @method('delete')

                        <button type="button" onclick="confirmDelete({{ $emailMachine->id }})"
